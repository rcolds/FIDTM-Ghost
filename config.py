...
parser.add_argument('--save_path', type=str, default='save_file/ShanghaiA',
...
# parser.add_argument('--pre', type=str, default='save_file/ShanghaiA/model_best.pth',
#                     help='pre-trained model directory')
parser.add_argument('--pre', type=str, default='',
                    help='pre-trained model directory')
parser.add_argument('--weight', type=str, default='save_file/ShanghaiA/model_best.pth',
                    help='pre-trained model directory')
